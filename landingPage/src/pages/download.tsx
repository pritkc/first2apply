      ...
      <DefaultLayout>
        <section className="w-full max-w-7xl min-h-[calc(100vh-56px)] md:min-h-[calc(100vh-64px)] mx-auto px-6 sm:px-10 pb-14 md:pb-16 flex flex-col items-center justify-center">
          ...
          <div className="mt-12 w-full xs:max-w-[500px] flex flex-col xs:flex-row xs:flex-wrap xs:items-center xs:justify-center gap-4">
            {/* macos apple silicon */}
            <a
              href="https://s3.eu-central-1.amazonaws.com/first2apply.com/releases/darwin/arm64/First+2+Apply-1.10.1-arm64.dmg"
              onClick={() => {
                sendGTMEvent({
                  event: "file_download",
                  file_extension: "dmg",
            ...
            {/* macos x64 */}
            <a
              href="https://s3.eu-central-1.amazonaws.com/first2apply.com/releases/darwin/x64/First+2+Apply-1.10.1-x64.dmg"
              onClick={() => {
                sendGTMEvent({
                  event: "file_download",
                  file_extension: "dmg",
            ...
            {/* linux */}
            <a
              href="https://s3.eu-central-1.amazonaws.com/first2apply.com/releases/linux/x64/first-2-apply_1.10.1_amd64.deb"
              onClick={() => {
                sendGTMEvent({
                  event: "file_download",
                  file_extension: "deb",
