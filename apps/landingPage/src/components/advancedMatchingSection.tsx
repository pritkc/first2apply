    ...
    >
      <div className="w-full md:w-1/2">
        ...
        <p className="mt-2 text-balance sm:mt-4 sm:text-lg md:text-right">
          ...
          refine job listings like: &quot;exclude jobs that require office visits, even if they’re labeled remote&quot;
          , &quot;hide fullstack roles that require python&quot;, &quot;only see positions with less than 2 years of
          experience&quot; and more.
