...
import { logger, flushLogger } from "./server/logger";
...
// globals
const autoUpdater = new F2aAutoUpdater(logger, quit);
...
async function bootstrap() {
  try {
    ...
    jobScanner = new JobScanner(logger, supabaseApi, htmlDownloader, navigate);
